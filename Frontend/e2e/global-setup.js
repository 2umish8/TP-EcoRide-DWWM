...
export default async function globalSetup() {
  ...
  try {
    ...
    try {
      ...
      console.log('⚠️ Could not register (might already exist), continuing to login ...')
    }
    ...
    try {
      ...
      console.log(
        'ℹ️ Add role may already exist or endpoint prevented it:',
    ...
    try {
      ...
      console.log(
        '⚠️ Could not create vehicle (maybe exists). Trying to fetch existing vehicles...',
      )
      try {
