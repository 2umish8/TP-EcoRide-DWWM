...
.hero-background::after {
  ...
  background:
    ...
    radial-gradient(circle at 25% 45%, var(--color-success) 25px, transparent 25px),
    radial-gradient(circle at 45% 65%, var(--color-primary) 20px, transparent 20px),
    radial-gradient(circle at 12% 80%, var(--color-success) 24px, transparent 24px),
    radial-gradient(circle at 50% 35%, var(--color-primary) 16px, transparent 16px),
    radial-gradient(circle at 20% 70%, var(--color-success) 19px, transparent 19px),
    radial-gradient(circle at 40% 85%, var(--color-success) 17px, transparent 17px);
  opacity: 0.3;
  z-index: 0;
  filter: blur(2px);
}
