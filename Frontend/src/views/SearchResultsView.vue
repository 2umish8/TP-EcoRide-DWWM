...
import TripFilters from '@/components/trips/filters/TripFilters.vue'
...
import SearchResultsLoading from '@/components/search/results/SearchResultsLoading.vue'
import SearchResultsError from '@/components/search/results/SearchResultsError.vue'
import SearchResultsEmpty from '@/components/search/results/SearchResultsEmpty.vue'
