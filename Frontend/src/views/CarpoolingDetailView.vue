    ...
    <div v-else-if="carpooling" class="content">
      ...
      <div class="trip-info card">
        <div class="route-header">
          ...
          <div class="duration-info">
            <font-awesome-icon :icon="['fas', 'clock-rotate-left']" /><span
              class="duration-value"
              >{{ formatDuration(carpooling.duration_minutes) }}</span
        ...
        <div class="trip-details">
          <div class="detail-item">
            <font-awesome-icon :icon="['fas', 'coins']" /><span class="value">{{
              carpooling.price_per_passenger
            }}</span
            ><IconCredit /><span class="label">par personne</span>
          </div>
          <div class="detail-item">
            <font-awesome-icon :icon="['fas', 'user-group']" /><span class="value">{{
      ...
      <div class="driver-info card">
        ...
        <div class="driver-card">
          ...
          <div class="driver-details">
            <h4 @click="viewDriverProfile(carpooling.driver_id)">
          ...
          <div class="vehicle-main">
            ...
            <div class="vehicle-specs">
              <span class="spec-item"
                ...
                ><span class="spec-value">{{ carpooling.color_name }}</span></span
              ><span class="spec-item"
                ><span class="spec-label">Plaque:</span
                ><span class="spec-value">{{ carpooling.plate_number }}</span></span
      ...
      <div class="preferences-info card">
        ...
        <div class="preferences-grid">
          <div class="preference-item">
            <font-awesome-icon :icon="['fas', 'smoking']" /><span class="pref-label">Fumeur:</span
            ><span class="pref-value">{{
              carpooling.driver_preferences?.allowsSmoking ? 'Autorisé' : 'Non autorisé'
            }}</span>
          </div>
          <div class="preference-item">
            <font-awesome-icon :icon="['fas', 'paw']" /><span class="pref-label">Animaux:</span
            ><span class="pref-value">{{
              carpooling.driver_preferences?.allowsPets ? 'Autorisés' : 'Non autorisés'
            }}</span>
          </div>
          <div class="preference-item">
            <font-awesome-icon :icon="['fas', 'comment']" /><span class="pref-label"
              >Conversation:</span
            ><span class="pref-value">{{
          ...
          <div class="preference-item" v-if="carpooling.driver_preferences?.specialRules">
            <font-awesome-icon :icon="['fas', 'clipboard-list']" /><span class="pref-label"
              >Règles spéciales:</span
      ...
      <div class="reviews-info card">
        ...
        <div class="reviews-list">
          ...
          <div v-else class="no-reviews"><p>Aucun avis disponible pour ce chauffeur.</p></div>
        </div>
      </div>
      <!-- Actions -->
      <div class="actions">
        ...
        >
          ...
          ><span v-else
            ><template v-if="carpooling.seats_remaining > 0"
              ><font-awesome-icon :icon="['fas', 'ticket']" /> Participer </template
      ...
      <div @click.stop>
        ...
        <div class="modal-content">
          ...
          <div class="confirmation-warning">
            <p>
              <font-awesome-icon :icon="['fas', 'triangle-exclamation']" /><strong
                >Attention :</strong
              >
              Une fois confirmée, votre participation sera définitive et vos crédits seront
              immédiatement débités.
            </p>
            <p>
        ...
        <div class="modal-actions">
          <button @click="closeConfirmationModal" :disabled="isConfirming">
            <font-awesome-icon :icon="['fas', 'xmark']" /> Annuler</button
          ><button @click="confirmParticipation" :disabled="isConfirming">
